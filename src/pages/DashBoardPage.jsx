...
const DashBoardPage = () => {
  ...
  return (
    <>
      <div className="w-[100%] md:h-[calc(100vh-65px)] p-1 pl-12 flex flex-col justify-start bg-[#f9f5f0]  ">
        {role === "Admin" ? <AInfoCards /> : <InfoCards />}
        <div className="flex flex-row justify-around  items-center bg-opacity-0 ">
